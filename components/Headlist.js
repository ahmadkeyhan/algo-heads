...
function Headlist() {
  const [activeTheme, setActiveTheme] = useState('light')
   ...
   const [sortedHeads, setSortedHeads] = useState([{sholder: {address: '', name: ''}, assetId: '761630099', src: '/algoHead001.png',bgColorCode: 6,price: 0},
                                                   ...
                                                   {sholder: {address: '4Y3V3EEKIKPH6XKN7KTIQGM5NHNZXPEWIMNFZYBVMKQGZWRXIKPNQJEZG4', name: ''}, assetId: '761648256', src: '/algoHead013.png',bgColorCode: 2,price: 0},
                                                   {sholder: {address: '4Y3V3EEKIKPH6XKN7KTIQGM5NHNZXPEWIMNFZYBVMKQGZWRXIKPNQJEZG4', name: ''}, assetId: '761649296', src: '/algoHead014.png',bgColorCode: 3,price: 0},
